...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::unprepared("DROP FUNCTION IF EXISTS new_id_peminjaman_barang");
        DB::unprepared(
          "CREATE FUNCTION new_id_peminjaman_barang()
            RETURNS CHAR(8)
            BEGIN
            ...
            IF(jumlah = 0) THEN
                SET kode_baru = CONCAT('PMB',0,0,0,0,1);
            ELSE
                SELECT MAX(id_peminjam) INTO kode_lama FROM peminjaman_barang;
    ...
    {
        Schema::dropIfExists('function_new_id_peminjaman_barang');
    }
};
