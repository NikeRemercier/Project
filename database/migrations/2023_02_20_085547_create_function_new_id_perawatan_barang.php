...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::unprepared("DROP FUNCTION IF EXISTS new_id_perawatan_barang");
        DB::unprepared(
          "CREATE FUNCTION new_id_perawatan_barang()
            RETURNS CHAR(8)
            BEGIN
            ...
            ELSE
                SELECT MAX(id_perawat) INTO kode_lama FROM perawatan_barang;
    ...
    {
        Schema::dropIfExists('function_new_id_perawatan_barang');
    }
};
